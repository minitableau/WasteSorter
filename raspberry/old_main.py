...
saved_model = tf.keras.models.load_model('models/model.h5')

predictions = saved_model.predict(test_array)
...
print(
    "This image n1 most likely belongs to {} with a {:.2f} percent confidence."
...
predictions2 = saved_model.predict(test_array2)
